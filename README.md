...
- **1.50 (feature, current)**: Improved UNO Q setup/start/update scripts (`init_unoq.sh`, `scripts/start.sh`, `scripts/update.sh`) and refined the dashboard presentation inspired by Lifeloop-style panel hierarchy.
- **1.40 (previous)**: Refactored the web UI into reusable templates/partials, modular CSS/JS assets, added a hardware control page, and introduced a stub AI dashboard panel for future expansion.
